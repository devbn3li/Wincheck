...
export default function Services({ locatService }) {
  ...
  return (
    <>
      <button
        className={`fixed bg-[#4840A3] text-white p-2 rounded-full shadow-lg hover:bg-[#EAB95C] transition-all flex justify-center items-center h-12 aspect-square ${
          isOpen ? "bottom-6 right-6" : "bottom-5 right-5"
        }`}
